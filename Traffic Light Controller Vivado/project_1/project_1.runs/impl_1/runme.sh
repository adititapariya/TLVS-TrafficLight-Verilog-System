...
HD_PWD='C:/Xilinx/Projects/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Traffic_Light_Controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Traffic_Light_Controller.tcl -notrace
